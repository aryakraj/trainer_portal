...
<form  method="post" action="<?php echo base_url()?>main/dashboard" class=" ">
<?php
...
<input type="text" name="fname" value="<?php echo $row1->fname;?>" required  class="form-control">

<label class="">Last Name:</label>
<input type="text" name="lname"  value="<?php echo $row1->lname;?>" required  class="form-control">
...
<input type="submit" name="submit" value="Back To Home" class="btn btn-primary w-50 mt-3  mb-3">
</div>
